...
-- 카테고리 10개
-- ============================================================
INSERT INTO categories (id, name, slug, description, sort_order, active, created_at, updated_at) VALUES
...
-- ============================================================
INSERT INTO products (name, description, price, discount_price, stock, thumbnail_url, category_id, brand, status, view_count, sales_count, featured, created_at, updated_at) VALUES
...
('캠핑 침낭 영하 10도',          '영하 10도까지 사용 가능. 사계절 캠핑 침낭.',                      85000, 65000, 40,  'https://images.unsplash.com/photo-1504280390367-361c6d9f38f4?w=400&h=400&fit=crop', 5, 'SleepOut',  'ACTIVE', 420, 48,  false, NOW(), NOW());
...
VALUES ('admin@shopmall.com', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iAt6Z5EH', '관리자', 'ADMIN', 'LOCAL', true, NOW(), NOW());
